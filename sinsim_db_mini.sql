...
CREATE TABLE `machine` (
  ...
  `machine_framework_create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `machine_order` (
  ...
  `machine_head_style` varchar(50) DEFAULT NULL,
  `container_size` varchar(100) DEFAULT NULL COMMENT '集装箱型号',
  `profit_margin` varchar(100) DEFAULT NULL COMMENT '利润率',
  `machine_weight` varchar(100) DEFAULT NULL COMMENT '机器重量',
  `finance_remark` varchar(255) DEFAULT NULL COMMENT '财务填写的备注 （不同于合同的备注）',
  `responsible_do_fee` varchar(100) DEFAULT NULL COMMENT '包干费',
  `delivery_fee` varchar(100) DEFAULT NULL COMMENT '运输费：',
  PRIMARY KEY (`id`),
...
CREATE TABLE `order_detail` (
  ...
  `special_towel_head` varchar(50) DEFAULT NULL,
  `special_zhirongxiu` varchar(50) DEFAULT NULL COMMENT '植绒绣',
  ...
  `framework_wire_rack` varchar(50) DEFAULT NULL COMMENT '机架台板系统：加线架',
  `framework_wire_rack_platen` varchar(50) DEFAULT NULL COMMENT '线架台板',
